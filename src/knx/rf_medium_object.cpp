    ...
    Property* properties[] =
        {
            ...
            new FunctionProperty<RfMediumObject>(this, PID_RF_BIDIR_TIMEOUT, [](RfMediumObject* io, uint8_t* data, uint8_t length, uint8_t* resultData, uint8_t& resultLength) {
            ...
            resultLength = 3; }, [](RfMediumObject* io, uint8_t* data, uint8_t length, uint8_t* resultData, uint8_t& resultLength) {
            resultData[0] = 0x00; // success
            resultData[1] = 0xFF; // permanent bidirectional device
            resultData[2] = 0xFF; // permanent bidirectional device
            resultLength = 3; }),
