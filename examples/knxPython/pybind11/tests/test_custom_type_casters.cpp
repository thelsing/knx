...
TEST_SUBMODULE(custom_type_casters, m)
{
    ...
    {
        public:
            ArgInspector1 f(ArgInspector1 a, ArgAlwaysConverts)
            {
                return a;
            }
            ...
            static ArgInspector2 h(ArgInspector2 a, ArgAlwaysConverts)
            {
                return a;
            }
    };
    ...
    m.def("floats_preferred", [](double f)
    {
        return 0.5 * f;
    }, "f"_a);
    m.def("floats_only", [](double f)
    {
        return 0.5 * f;
    }, "f"_a.noconvert());
    m.def("ints_preferred", [](int i)
    {
        return i / 2;
    }, "i"_a);
    m.def("ints_only", [](int i)
    {
        return i / 2;
    }, "i"_a.noconvert());
    ...
    m.def("other_lib_type", [](other_lib::MyType x)
    {
        return x;
    });
