...
namespace
{
    ...
    class shared_ptr_with_addressof_operator
    {
        ...
        public:
            ...
            T** operator&()
            {
                throw std::logic_error("Call of overloaded operator& is not expected");
            }
    };
    ...
    {
        public:
            explicit MyObject1(int value) : value(value)
            {
    ...
    class MyObject2
    {
        public:
            ...
            explicit MyObject2(int value) : value(value)
            {
                print_created(this, toString());
            }
    ...
    class MyObject3 : public std::enable_shared_from_this<MyObject3>
    {
        public:
            ...
            explicit MyObject3(int value) : value(value)
            {
                print_created(this, toString());
            }
            std::string toString() const
    ...
    {
        public:
            explicit MyObject4b(int i) : MyObject4a(i)
            {
                print_created(this);
            }
            ~MyObject4b() override
    ...
    {
        public:
            explicit MyObject5(int value) : value{value}
            {
                print_created(this);
            }
            ~MyObject5()
    ...
    struct SharedFromThisRef
    {
        struct B : std::enable_shared_from_this<B>
        {
            ...
            B(const B&) : std::enable_shared_from_this<B>()
            {
                print_copy_created(this);
            }
            B(B&&) noexcept : std::enable_shared_from_this<B>()
            {
                print_move_created(this);
            }
            ~B()
    ...
    struct TypeForHolderWithAddressOf
    {
        ...
        TypeForHolderWithAddressOf(const TypeForHolderWithAddressOf&)
        {
            print_copy_created(this);
        }
    ...
    {
        explicit TypeForMoveOnlyHolderWithAddressOf(int value) : value{value}
        {
            print_created(this);
        }
    ...
    struct ElementList
    {
        void add(const std::shared_ptr<ElementBase>& e)
        {
            l.push_back(e);
        }
...
TEST_SUBMODULE(smart_ptr, m)
{
    ...
    m.def("print_object_1", [](const Object * obj)
    {
        py::print(obj->toString());
    });
    m.def("print_object_2", [](ref<Object> obj)
    {
        py::print(obj->toString());
    });
    m.def("print_object_3", [](const ref<Object>& obj)
    {
        py::print(obj->toString());
    });
    m.def("print_object_4", [](const ref<Object>* obj)
    {
        py::print((*obj)->toString());
    });
    m.def("print_myobject1_1", [](const MyObject1 * obj)
    {
        py::print(obj->toString());
    });
    m.def("print_myobject1_2", [](ref<MyObject1> obj)
    {
        py::print(obj->toString());
    });
    m.def("print_myobject1_3", [](const ref<MyObject1>& obj)
    {
        py::print(obj->toString());
    });
    m.def("print_myobject1_4", [](const ref<MyObject1>* obj)
    {
        py::print((*obj)->toString());
    });
    ...
    m.def("make_myobject2_1", []()
    {
        return new MyObject2(6);
    });
    m.def("make_myobject2_2", []()
    {
        return std::make_shared<MyObject2>(7);
    });
    m.def("print_myobject2_1", [](const MyObject2 * obj)
    {
        py::print(obj->toString());
    });
    // NOLINTNEXTLINE(performance-unnecessary-value-param)
    m.def("print_myobject2_2", [](std::shared_ptr<MyObject2> obj)
    {
        py::print(obj->toString());
    });
    ...
    m.def("make_myobject3_1", []()
    {
        return new MyObject3(8);
    });
    m.def("make_myobject3_2", []()
    {
        return std::make_shared<MyObject3>(9);
    });
    m.def("print_myobject3_1", [](const MyObject3 * obj)
    {
        py::print(obj->toString());
    });
    // NOLINTNEXTLINE(performance-unnecessary-value-param)
    m.def("print_myobject3_2", [](std::shared_ptr<MyObject3> obj)
    {
        py::print(obj->toString());
    });
    ...
    py::return_value_policy::copy)
    .def("set_ref", [](SharedPtrRef&, const A&)
    {
        return true;
    })
    // NOLINTNEXTLINE(performance-unnecessary-value-param)
    .def("set_holder", [](SharedPtrRef&, std::shared_ptr<A>)
    {
        return true;
    });
    ...
    py::return_value_policy::copy)
    .def("set_ref", [](SharedFromThisRef&, const B&)
    {
        return true;
    })
    // NOLINTNEXTLINE(performance-unnecessary-value-param)
    .def("set_holder", [](SharedFromThisRef&, std::shared_ptr<B>)
    {
        return true;
    });
    ...
    py::class_<C, custom_unique_ptr<C>>(m, "TypeWithMoveOnlyHolder")
                                     .def_static("make", []()
    {
        return custom_unique_ptr<C>(new C);
    })
    .def_static("make_as_object", []()
    {
        return py::cast(custom_unique_ptr<C>(new C));
    });
    ...
    .def_static("make", []()
    {
        return HolderWithAddressOf(new TypeForHolderWithAddressOf);
    })
    .def("get", [](const HolderWithAddressOf & self)
    {
        return self.get();
    })
    .def("print_object_1",
    ...
    // NOLINTNEXTLINE(performance-unnecessary-value-param)
    .def("print_object_2", [](HolderWithAddressOf obj)
    {
