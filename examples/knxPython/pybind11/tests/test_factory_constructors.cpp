...
class TestFactory1
{
        ...
        TestFactory1() : value("(empty)")
        {
            print_default_created(this);
        }
        explicit TestFactory1(int v) : value(std::to_string(v))
        {
            print_created(this, value);
        }
        explicit TestFactory1(std::string v) : value(std::move(v))
        {
            print_created(this, value);
        }
...
{
        friend class TestFactoryHelper;
        TestFactory2() : value("(empty2)")
        {
            print_default_created(this);
        }
        explicit TestFactory2(int v) : value(std::to_string(v))
        {
            print_created(this, value);
        }
        explicit TestFactory2(std::string v) : value(std::move(v))
        {
            print_created(this, value);
        }

    public:
        TestFactory2(TestFactory2&& m) noexcept : value
        {
            std::move(m.value)
        }
        {
...
class TestFactory3
{
    protected:
        friend class TestFactoryHelper;
        TestFactory3() : value("(empty3)")
        {
            print_default_created(this);
        }
        explicit TestFactory3(int v) : value(std::to_string(v))
        {
            print_created(this, value);
        }

    public:
        explicit TestFactory3(std::string v) : value(std::move(v))
        {
            print_created(this, value);
        }
        TestFactory3(TestFactory3&& m) noexcept : value
        {
            std::move(m.value)
        }
        {
...
{
    public:
        TestFactory4() : TestFactory3()
        {
            print_default_created(this);
        }
        explicit TestFactory4(int v) : TestFactory3(v)
        {
...
{
    public:
        explicit TestFactory5(int i) : TestFactory3(i)
        {
...
class TestFactory6
{
    ...
    public:
        explicit TestFactory6(int i) : value{i}
        {
            print_created(this, i);
        }
...
class PyTF6 : public TestFactory6
{
    public:
        ...
        PyTF6(PyTF6&& f) noexcept : TestFactory6(std::move(f))
        {
            print_move_created(this);
        }
        PyTF6(const PyTF6& f) : TestFactory6(f)
        {
            print_copy_created(this);
        }
        ...
        int get() override
        {
            PYBIND11_OVERRIDE(int, TestFactory6, get, /*no args*/);
        }
};
...
class TestFactory7
{
    ...
    public:
        explicit TestFactory7(int i) : value{i}
        {
            print_created(this, i);
        }
...
class PyTF7 : public TestFactory7
{
    public:
        ...
        PyTF7(PyTF7&& f) noexcept : TestFactory7(std::move(f))
        {
            print_move_created(this);
        }
        PyTF7(const PyTF7& f) : TestFactory7(f)
        {
            print_copy_created(this);
        }
        ~PyTF7() override
        ...
        int get() override
        {
            PYBIND11_OVERRIDE(int, TestFactory7, get, /*no args*/);
        }
};
...
class TestFactoryHelper
{
    public:
        ...
        {
            return TestFactory2(std::move(a));
        }
...
#define MAKE_TAG_TYPE(Name)                                                                       \
    ...
    .def(py::init([](unique_ptr_tag, int v)
    {
        return TestFactoryHelper::construct1(v);
    }))
    .def(py::init(&TestFactoryHelper::construct1_string)) // raw function pointer
    .def(py::init([](pointer_tag)
    {
        return TestFactoryHelper::construct1();
    }))
    .def(py::init(
             [](py::handle, int v, py::handle)
    {
        return TestFactoryHelper::construct1(v);
    }))
    .def_readwrite("value", &TestFactory1::value);
    py::class_<TestFactory2>(m, "TestFactory2")
    .def(py::init([](pointer_tag, int v)
    {
        return TestFactoryHelper::construct2(v);
    }))
    .def(py::init([](unique_ptr_tag, std::string v)
    {
        return TestFactoryHelper::construct2(std::move(v));
    }))
    .def(py::init([](move_tag)
    {
        return TestFactoryHelper::construct2();
    }))
    ...
    .def(py::init([](pointer_tag, int v)
    {
        return TestFactoryHelper::construct3(v);
    }))
    .def(py::init([](shared_ptr_tag)
    {
        return TestFactoryHelper::construct3();
    }));
    ...
    .def(py::init([](pointer_tag, TF5_tag, int a)
    {
        return new TestFactory5(a);
    }))
    // derived shared ptr:
    .def(py::init(
             [](shared_ptr_tag, TF4_tag, int a)
    {
        return std::make_shared<TestFactory4>(a);
    }))
    .def(py::init(
             [](shared_ptr_tag, TF5_tag, int a)
    {
        return std::make_shared<TestFactory5>(a);
    }))

    // Returns nullptr:
    .def(py::init([](null_ptr_tag)
    {
        return (TestFactory3*) nullptr;
    }))
    .def(py::init([](null_unique_ptr_tag)
    {
        return std::unique_ptr<TestFactory3>();
    }))
    .def(py::init([](null_shared_ptr_tag)
    {
    ...
    .def(py::init([](base_tag, int i)
    {
        return TestFactory6(i);
    }))
    .def(py::init([](alias_tag, int i)
    {
        return PyTF6(i);
    }))
    .def(py::init([](alias_tag, std::string s)
    {
        return PyTF6(std::move(s));
    }))
    .def(py::init([](alias_tag, pointer_tag, int i)
    {
        return new PyTF6(i);
    }))
    .def(py::init([](base_tag, pointer_tag, int i)
    {
        return new TestFactory6(i);
    }))
    .def(py::init(
             [](base_tag, alias_tag, pointer_tag, int i)
    {
        return (TestFactory6*) new PyTF6(i);
    }))
    ...
    py::class_<TestFactory7, PyTF7, std::shared_ptr<TestFactory7>>(m, "TestFactory7")
            .def(py::init([](int i)
    {
        return TestFactory7(i);
    }, [](int i)
    {
        return PyTF7(i);
    }))
    .def(py::init([](pointer_tag, int i)
    {
    ...
    .def(py::init([](mixed_tag, const std::string & s)
    {
        return TestFactory7((int) s.size());
    },
    [](mixed_tag, const std::string & s)
    {
        return new PyTF7((int) s.size());
    }))
    .def(py::init([](base_tag, pointer_tag, int i)
    {
        return new TestFactory7(i);
    },
    [](base_tag, pointer_tag, int i)
    {
        return (TestFactory7*) new PyTF7(i);
    }))
    .def(py::init([](alias_tag, pointer_tag, int i)
    {
        return new PyTF7(i);
    },
    [](alias_tag, pointer_tag, int i)
    {
    ...
    struct NoisyAlloc
    {
        ...
        explicit NoisyAlloc(int i)
        {
            py::print(py::str("NoisyAlloc(int {})").format(i));
        }
        explicit NoisyAlloc(double d)
        {
            py::print(py::str("NoisyAlloc(double {})").format(d));
        }
        ~NoisyAlloc()
        {
            py::print("~NoisyAlloc()");
        ...
        {
            py::print("noisy placement delete");
        }
    };
    ...
    ignoreOldStyleInitWarnings([&pyNoisyAlloc]()
    {
        pyNoisyAlloc.def("__init__",
                         [](NoisyAlloc & a, double d, double)
        {
            new (&a) NoisyAlloc(d);
        });
    });
    // Requires deallocation of previous overload preallocated value:
    pyNoisyAlloc.def(py::init([](int i, double)
    {
        return new NoisyAlloc(i);
    }));
    ...
    {
        pyNoisyAlloc.def(
            "__init__", [](NoisyAlloc & a, int i, const std::string&)
        {
            new (&a) NoisyAlloc(i);
        });
    });
    ...
    bf1.def(py::init([]()
    {
        return std::shared_ptr<BadF1Base>(new BadF1());
    }));
#endif
}
