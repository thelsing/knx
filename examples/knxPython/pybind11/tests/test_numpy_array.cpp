...
TEST_SUBMODULE(numpy_array, sm)
{
    ...
    sm.def("ndim", [](const arr & a)
    {
        return a.ndim();
    });
    sm.def("shape", [](const arr & a)
    {
        return arr(a.ndim(), a.shape());
    });
    sm.def("shape", [](const arr & a, py::ssize_t dim)
    {
        return a.shape(dim);
    });
    sm.def("strides", [](const arr & a)
    {
        return arr(a.ndim(), a.strides());
    });
    sm.def("strides", [](const arr & a, py::ssize_t dim)
    {
        return a.strides(dim);
    });
    sm.def("writeable", [](const arr & a)
    {
        return a.writeable();
    });
    sm.def("size", [](const arr & a)
    {
        return a.size();
    });
    sm.def("itemsize", [](const arr & a)
    {
        return a.itemsize();
    });
    sm.def("nbytes", [](const arr & a)
    {
        return a.nbytes();
    });
    sm.def("owndata", [](const arr & a)
    {
        return a.owndata();
    });
    ...
    sm.def("scalar_int", []()
    {
        return py::array(py::dtype("i"), {}, {}, &data_i);
    });
    ...
    sm.def("overloaded", [](const py::array_t<double>&)
    {
        return "double";
    });
    sm.def("overloaded", [](const py::array_t<float>&)
    {
        return "float";
    });
    sm.def("overloaded", [](const py::array_t<int>&)
    {
        return "int";
    });
    sm.def("overloaded", [](const py::array_t<unsigned short>&)
    {
        return "unsigned short";
    });
    sm.def("overloaded", [](const py::array_t<long long>&)
    {
        return "long long";
    });
    sm.def("overloaded",
    ...
    sm.def("overloaded", [](const py::array_t<std::complex<float>>&)
    {
    ...
    sm.def("overloaded2", [](const py::array_t<double>&)
    {
        return "double";
    });
    sm.def("overloaded2",
    ...
    sm.def("overloaded2", [](const py::array_t<float>&)
    {
        return "float";
    });
    ...
    sm.def("overloaded3", [](const py::array_t<int>&)
    {
        return "int";
    }, py::arg{}.noconvert());
    sm.def(
    ...
    sm.def("overloaded4", [](const py::array_t<long long, 0>&)
    {
        return "long long";
    });
    sm.def("overloaded4", [](const py::array_t<double, 0>&)
    {
        return "double";
    });
    ...
    // without conversion)
    sm.def("overloaded5", [](const py::array_t<unsigned int>&)
    {
        return "unsigned int";
    });
    sm.def("overloaded5", [](const py::array_t<double>&)
    {
        return "double";
    });
    ...
    sm.def("issue685", [](const std::string&)
    {
        return "string";
    });
    sm.def("issue685", [](const py::array&)
    {
        return "array";
    });
    sm.def("issue685", [](const py::object&)
    {
        return "other";
    });
    ...
    // empty object:
    sm.def("array_fail_test", []()
    {
        return py::array(py::object());
    });
    sm.def("array_t_fail_test", []()
    {
    ...
    sm.def("array_initializer_list2", []()
    {
        return py::array_t<float>({1, 2});
    });
    sm.def("array_initializer_list3", []()
    {
        return py::array_t<float>({1, 2, 3});
    });
    sm.def("array_initializer_list4", []()
    {
    ...
    sm.def("array_resize3",
           [](py::array_t<double> a, size_t N, bool refcheck)
    {
    ...
    sm.def("array_view",
           [](py::array_t<uint8_t> a, const std::string & dtype)
    {
        return a.view(dtype);
    });

    sm.def("reshape_initializer_list",
           [](py::array_t<int> a, size_t N, size_t M, size_t O)
    {
    ...
    sm.def("round_trip_float", [](double d)
    {
        return d;
    });
