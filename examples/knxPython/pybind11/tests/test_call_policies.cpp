...
struct CustomGuard
{
    ...
    {
        return enabled ? "guarded" : "unguarded";
    }
};
...
TEST_SUBMODULE(call_policies, m)
{
    ...
    class Child
    {
        public:
            Child()
            {
                py::print("Allocating child.");
            }
            Child(const Child&) = default;
            Child(Child&&) = default;
            ~Child()
            {
                py::print("Releasing child.");
            }
    };
    ...
    class Parent
    {
        public:
            Parent()
            {
                py::print("Allocating parent.");
            }
            Parent(const Parent& parent) = default;
            ~Parent()
            {
                py::print("Releasing parent.");
            }
            void addChild(Child*) {}
            Child* returnChild()
            {
            ...
            Child* returnNullChild()
            {
                return nullptr;
            }
            static Child* staticFunction(Parent*)
            {
                return new Child();
            }
    };
