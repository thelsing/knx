...
class ExampleMandA
{
    public:
        ...
        explicit ExampleMandA(int value) : value(value)
        {
        ...
        ExampleMandA(ExampleMandA&& e) noexcept : value(e.value)
        {
        ...
        {
            value += other.value;    // passing by value
        }
        void add2(ExampleMandA& other)
        {
            value += other.value;    // passing by reference
        }
        void add3(const ExampleMandA& other)
        {
            value += other.value;    // passing by const reference
        }
        void add4(ExampleMandA* other)
        {
            value += other->value;    // passing by pointer
        }
        void add5(const ExampleMandA* other)
        {
            value += other->value;    // passing by const pointer
        }

        void add6(int other)
        {
            value += other;    // passing by value
        }
        void add7(int& other)
        {
            value += other;    // passing by reference
        }
        void add8(const int& other)
        {
            value += other;    // passing by const reference
        }
        // NOLINTNEXTLINE(readability-non-const-parameter) Deliberately non-const for testing
        void add9(int* other)
        {
            value += *other;    // passing by pointer
        }
        void add10(const int* other)
        {
            value += *other;    // passing by const pointer
        }
        ...
        {
            return *this;    // return by const reference
        }
        ExampleMandA* self4()
        {
        ...
        {
            return this;    // return by const pointer
        }
        ...
        {
            return value;    // return by const reference
        }
        int* internal4()
        {
            return &value;    // return by pointer
        }
        const int* internal5()
        {
            return &value;    // return by const pointer
        }
...
TEST_SUBMODULE(methods_and_attributes, m)
{
    ...
    .def_property("def_writeonly", nullptr, [](TestProperties & s, int v)
    {
        s.value = v;
    })
    ...
    .def_property_static("def_writeonly_static",
                         nullptr,
                         [](const py::object&, int v)
    {
        TestProperties::static_value = v;
    })
    ...
    .def_property_static(
        ...
        [](const py::object&, int v)
    {
        return TestProperties::static_set(v);
    })
    .def_property_static(
        "def_property_static",
        [](const py::object&)
    ...
    [](const py::object & cls, const py::function & f)
    {
        f(cls);
    });
    ...
    auto static_set1 = [](const py::object&, int v)
    {
        TestPropRVP::sv1.set(v);
    };
    auto static_set2 = [](const py::object&, int v)
    {
        TestPropRVP::sv2.set(v);
    };
    ...
    .def_property_readonly_static("readonly", [](const py::object&)
    {
        return 1;
    });

    // test_overload_ordering
    m.def("overload_order", [](const std::string&)
    {
        return 1;
    });
    m.def("overload_order", [](const std::string&)
    ...
    {
        return NoneCastTester{};
    }));
    py::implicitly_convertible<py::none, NoneCastTester>();
    m.def("ok_obj_or_none", [](NoneCastTester const & foo)
    {
        return foo.answer;
    });
