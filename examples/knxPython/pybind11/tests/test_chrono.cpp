...
TEST_SUBMODULE(chrono, m)
{
    ...
    m.def("test_chrono2", [](system_time t)
    {
        return t;
    });
    ...
    m.def("test_chrono3", [](std::chrono::system_clock::duration d)
    {
        return d;
    });
    ...
    m.def("test_chrono4", [](system_time a, system_time b)
    {
        return a - b;
    });
    ...
    m.def("test_chrono6", [](steady_time t)
    {
        return t;
    });
    ...
    m.def("test_chrono7", [](std::chrono::microseconds t)
    {
        return t;
    });
    // Float durations (issue #719)
    m.def("test_chrono_float_diff",
          [](std::chrono::duration<float> a, std::chrono::duration<float> b)
    {
        return a - b;
    });
