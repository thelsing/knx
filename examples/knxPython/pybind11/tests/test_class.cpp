...
TEST_SUBMODULE(class_, m)
{
    ...
    m.def("as_type", [](const py::object & ob)
    {
        return py::type(ob);
    });
    ...
    m.def("implicitly_convert_argument", [](const ConvertibleFromUserType & r)
    {
        return r.i;
    });
    ...
    m.add_object("implicitly_convert_variable_fail", [&]
    {
        ...
        py::capsule def_capsule(def,
                                [](void* ptr)
        {
            delete reinterpret_cast<PyMethodDef*>(ptr);
        });
    ...
    class ProtectedB
    {
        ...
        protected:
            ...
            virtual void* void_foo()
            {
                return static_cast<void*>(&value);
            }
            virtual void* get_self()
            {
    ...
    class TrampolineB : public ProtectedB
    {
        public:
            ...
            {
                PYBIND11_OVERRIDE(int, ProtectedB, foo, );
            }
            void* void_foo() override
            {
                PYBIND11_OVERRIDE(void*, ProtectedB, void_foo, );
            }
            void* get_self() override
            {
                PYBIND11_OVERRIDE(void*, ProtectedB, get_self, );
            }
    };
    ...
    m.def("pointers_equal",
          [](const void* original, const void* comparison)
    {
