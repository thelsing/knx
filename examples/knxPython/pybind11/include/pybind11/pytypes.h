...
class object_api : public pyobject_tag
{
    ...
    public:
        ...
        template <return_value_policy policy = return_value_policy::automatic_reference,
                  typename... Args> PYBIND11_DEPRECATED("call(...) was deprecated in favor of operator()(...)")
...
class handle : public detail::object_api<handle>
{
    public:
        ...
        // NOLINTNEXTLINE(google-explicit-constructor) handle(T ptr) : m_ptr(ptr) {}
        ...
        template <
            ...
            detail::enable_if_t<detail::all_of<detail::none_of<std::is_base_of<handle, T>,
                                ...
                                int>
            = 0 >
        // NOLINTNEXTLINE(google-explicit-constructor) handle(T &obj) : m_ptr(obj) {}
...
PYBIND11_WARNING_PUSH PYBIND11_WARNING_DISABLE_MSVC(4522) // warning C4522: multiple assignment operators specified
template <typename Policy>
class accessor : public object_api<accessor<Policy>>
{
    ...
    public:
        ...
        template <typename T = Policy> PYBIND11_DEPRECATED(
        ...
        template <typename T = Policy> PYBIND11_DEPRECATED("Use of obj[key] as bool is deprecated in favor of obj.contains(key)")
        explicit
...
class str : public object
{
    public:
        ...
        // NOLINTNEXTLINE(google-explicit-constructor) str(T s) : str(s.data(), s.size()) {}
...
class bytes : public object
{
    public:
        ...
        template <typename SzType, detail::enable_if_t<std::is_integral<SzType>::value, int> = 0> bytes(const char* c, const SzType& n)
        ...
        // enable_if is needed to avoid "ambiguous conversion" errors (see PR #3521).
        template <typename T, detail::enable_if_t<std::is_same<T, std::string_view>::value, int> = 0>
        // NOLINTNEXTLINE(google-explicit-constructor) bytes(T s) : bytes(s.data(), s.size()) {}
...
class int_ : public object
{
    public:
        ...
        // NOLINTNEXTLINE(google-explicit-constructor) int_(T value)
        {
        ...
        template <typename T, detail::enable_if_t<std::is_integral<T>::value, int> = 0>
        // NOLINTNEXTLINE(google-explicit-constructor) operator T() const
        {
...
class capsule : public object
{
    public:
        ...
        template <typename T> operator T* () const   // NOLINT(google-explicit-constructor)
        {
