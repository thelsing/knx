...
# -*- coding: utf-8 -*-
#
# knx documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'knx.tex', 'knx Documentation',
     'Thomas Kunze', 'manual'),
]
...
man_pages = [
    (master_doc, 'knx', 'knx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'knx', 'knx Documentation',
     author, 'knx', 'One line description of project.',
     'Miscellaneous'),
]
